...
<div class="table-responsive col-lg-8">
    <a href="/dashboard/tournaments/create" class="btn btn-primary mb-3">Create new tournament</a>
    <table class="table table-striped table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/dashboard/tournaments/{{ $tournament->slug }}" class="badge bg-info"><span data-feather="eye"></span></a>
